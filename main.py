...
if __name__ == '__main__':
    ...
    # #导入预训练模型
    # model_dir = os.path.join('./results', 'simple_tag_v2', '15','model.pt')#第15个model效果不错
    # maddpg.load(dim_info, model_dir)
    ...
    for episode in range(args.episode_num):
        ...
        while env.agents:  # interact with the env for an episode
            ...
            next_obs, reward, done, info = env.step(action)#bug
            # env.render()
            ...
            if step >= args.random_steps and step % args.learn_interval == 0:  # learn every few steps 学习
